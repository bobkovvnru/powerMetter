...
#define    INA226_MANUFACTURER_ID     0xFE // readonly
#define    INA226_DIE_ID              0xFF // readonly
...
status AutoFox_INA226_Hibernate(); //Enters a very low power mode, no voltage measurements
status AutoFox_INA226_Wakeup();    //Wake-up and enter the last operating mode
...
status AutoFox_INA226_ResetAlertPin(enum  eAlertTriggerCause* aAlertTriggerCause_p ); //provides feedback as to what caused the alert
